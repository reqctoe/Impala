...
class BreadthFirst:
    ...
    def run_breadth_first(self): 
        """
        Attempts to solve the rush hour game using breadth first search. 
        """
        count = 0
        ...
        while self.state_keys:
            ...
            if count % 100 == 0:
                # if used in breadthfirst improver, subtract number of steps already taken
    ...
    def get_next_state(self):
        ...
        # get state data from archive
        state_data = self.states[key]

        # set value of checked states to empty, to save memory
        self.states[key] = ""
